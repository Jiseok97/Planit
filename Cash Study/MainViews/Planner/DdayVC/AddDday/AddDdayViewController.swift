...
class AddDdayViewController: UIViewController, UITextFieldDelegate  {
    ...
    @IBAction func deleteTapBtn(_ sender: Any) {
        let vc = AlertViewController(mainMsg: "디데이를 삭제하시겠습니까?", subMsg: "", btnTitle: "삭제", isTimer: false, isLogout: false, studyRemove: false)
        vc.modalPresentationStyle = .overFullScreen
        present(vc, animated: true)
    }
