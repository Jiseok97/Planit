...
class MyPageViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    @objc func questionTapped(_ sender: UITapGestureRecognizer) {
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            // 팝업창 멘트 정하기
            let vc = ObAlertViewController(mainMsg: "메일을 가져올 수 없습니다", subMsg: "기기의 메일 설정을 확인해주세요", heightValue: 0.22, btnTitle: "확인", isTimer: false, isMypage: true, networkConnect: false)
